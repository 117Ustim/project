...
// document.querySelector('button').onclick = function f3() {

//     one.innerHTML += d11.indexOf(+input.value);
...
//         if (+input.value === d15[i]) {
//             all = false;
//             one.innerHTML += 'Есть такое число';
//             break;
//         }
...
//     one.innerHTML += (d18.includes(input.value));
// };


// let m = ['Your', 'payment', 'method', 'will', 'automaticall', 'be', 'charged', 'in', 'advance', 'every'];
// document.querySelector('button').onclick = function () {
//     let a = 0;
//     for (let i = 0; i < m.length; i++) {
//         if (m[i].length > a) {
